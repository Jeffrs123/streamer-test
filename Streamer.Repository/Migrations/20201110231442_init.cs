        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateEvento = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesProjects", x => new { x.CourseId, x.ProjectId });
                    table.ForeignKey(
                        name: "FK_CoursesProjects_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoursesProjects_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursesProjects_ProjectId",
